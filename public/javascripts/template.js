...
.mj-column-per-45 { width:45% !important; max-width: 45%; }
  ...
  @media only screen and (max-width:480px) {
    ...
    <img
       height="auto" src="https://res.cloudinary.com/hanqgr02n/image/upload/v1562866169/zen-images/logo_modsf6.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="40"
    />
    ...
    >
      <p align="center"> Thank you for joining our community! Please <a href="${message}" style="color: #3498DB;">
      confirm
    </a> your sign up </p>
